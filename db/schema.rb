...
ActiveRecord::Schema.define(version: 2021_03_10_104229) do
  ...
  create_table "bidding_profiles", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["freelancer_id"], name: "index_bidding_profiles_on_freelancer_id"
  end
  ...
  add_foreign_key "bidding_profiles", "users", column: "freelancer_id"
